...
class DesmosCalculatorManager {
    ...
    addCoreExpressions() {
        const coreExpressions = [
            ...
            {id: 'H_phase', latex: '\\operatorname{phi_{H}}=-90-\\frac{180}{\\pi}\\cdot\\arctan\\left(\\operatorname{real}\\left(H\\left(s\\right)\\right),\\operatorname{imag}\\left(H\\left(s\\right)\\right)\\right)', folderId: 'expressions'},
